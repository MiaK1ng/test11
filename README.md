...
titleLabel.Text = "Insira sua chave"
titleLabel.BackgroundColor3 = Color3.new(0.2, 0.2, 0.2)
titleLabel.TextColor3 = Color3.new(1, 1, 1)
titleLabel.TextScaled = true

-- Adicionar campo de texto para entrada da chave
local inputBox = Instance.new("TextBox", frame)
inputBox.Size = UDim2.new(1, -20, 0, 50)
inputBox.Position = UDim2.new(0, 10, 0, 40)
inputBox.BackgroundColor3 = Color3.new(1, 1, 1)
inputBox.PlaceholderText = "Digite a chave aqui"
...
submitButton.MouseButton1Click:Connect(function()
    local playerInput = inputBox.Text
    -- Aqui você pode verificar a chave como desejar
    if playerInput == "A7B8C9D0,J4K5L6M7,N1O2P3Q4,R5S6T7U8,X9Y8Z7A6,B2C3D4E5,H8I7J6K5,Q1R2S3T4,V5W6X7Y8,Z0A1B2C3,0864QYRS,2TV09ZR2,C173W5JH,BZ6E1HTD,8S1HQHU1,EHH182BN,8PNXLFLK,9KWCUA11,LIM3396X,SBHO4D8A" then
        print("Chave correta! Iniciando o script...")
        -- Iniciar o seu script aqui
    else
        player:Kick("Chave incorreta. Tente novamente.")
    end
end)
...
local Window = OrionLib:MakeWindow({Name = "MiaK1ng Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "MiaK1ng Hub"})

OrionLib:MakeNotification({
	Name = "MiaK1ng Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://124777527517077",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://124777527517077",
    PremiumOnly = false
})
...
W:AddLabel("[+] MiaK1ng Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "MiaK1ng Hub(Noitification)",
